...
<head>
	...
	<title>Ecology & Environment HTML5 Template</title>
			...
			<div class="row g-0">
				<div class="col-xl-6 col-lg-6">
					<div class="breadcrumb-content" style="background-image: url(assets/img/bg/breadcrumb-bg.webp)">
						...
						<div class="shape-1"><img alt="shape" src="assets/img/shapes/shape-1.webp"></div>
					</div>
				</div>
				<div class="col-xl-6 col-lg-6 d-none d-lg-block">
					<div class="breadcrumb-thumb"><img alt="thumb" src="assets/img/thumbs/thumb-1.webp"></div>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row justify-content-center text-center m-b-50 m-b-xs-40">
				<div class="col-xl-8">
					<div class="common-subtitle" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
						<img alt="icon-1" src="assets/img/icons/icon-2.svg"> <span>Our Camping</span>
					</div>
			...
			<div class="row" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
				<div class="col-xl-6 m-b-30">
					<div class="project-card style-2 style-service">
						<div class="thumb">
							<a href='project-details.html'><img alt="thumb-63" src="assets/img/thumbs/thumb-69.webp"></a>
							<div class="tag">
								<p>No - 02</p>
							</div>
							<div class="content">
								...
								<div class="join-us">
									<a class='e-primary-btn has-icon' href='project-details.html'>Read More <span class="icon-wrap"><span class="icon"><i class="fa-regular fa-arrow-right"></i> <i class="fa-regular fa-arrow-right"></i></span></span></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-xl-6 m-b-30">
					<div class="project-card style-2 style-service">
						<div class="thumb">
							<a href='project-details.html'><img alt="thumb-63" src="assets/img/thumbs/thumb-70.webp"></a>
							<div class="tag">
								<p>No - 03</p>
							</div>
							<div class="content">
				...
				<div class="col-xl-6 m-b-30">
					<div class="project-card style-2 style-service">
						<div class="thumb">
							<a href='project-details.html'><img alt="thumb-63" src="assets/img/thumbs/thumb-71.webp"></a>
							<div class="tag">
								<p>No - 02</p>
							</div>
							<div class="content">
				...
				<div class="col-xl-6 m-b-30">
					<div class="project-card style-2 style-service">
						<div class="thumb">
							<a href='project-details.html'><img alt="thumb-63" src="assets/img/thumbs/thumb-72.webp"></a>
							<div class="tag">
								<p>No - 02</p>
							</div>
							<div class="content">
				...
				<div class="col-xl-6 m-b-30">
					<div class="project-card style-2 style-service">
						<div class="thumb">
							<a href='project-details.html'><img alt="thumb-63" src="assets/img/thumbs/thumb-73.webp"></a>
							<div class="tag">
								<p>No - 02</p>
							</div>
							<div class="content">
				...
				<div class="col-xl-6 m-b-30">
					<div class="project-card style-2 style-service">
						<div class="thumb">
							<a href='project-details.html'><img alt="thumb-63" src="assets/img/thumbs/thumb-74.webp"></a>
							<div class="tag">
								<p>No - 02</p>
							</div>
							<div class="content">
			...
			<div class="row">
				<div class="col-xl-12">
					<div class="contact-info-layout">
						<a class="contact-info active" href="mailto:support.econest@gmail.com">
							<div class="icon-wrap">
							...
							<p>Send a Email</p></a> <a class="contact-info" href="tel:+70264566579">
						<div class="icon-wrap">
							<div class="icon-shape"></div>
							<div class="icon">
						...
						<p>Any Time Call Us</p></a> <a class="contact-info" href="#">
						<div class="icon-wrap">
							<div class="icon-shape"></div>
							<div class="icon">
